...
class MiniBatch_GD():
	...
	def __init__(self):
	 ...
	 self.network.add(keras.layers.Conv2D(32, kernel_size=3, kernel_regularizer=keras.regularizers.l2(0.01), 
									  bias_regularizer=keras.regularizers.l2(0.01), input_shape=(28,28,1)))
...
# show image using matplotlib
	...
	hist = mbgd.network.fit(train_data, train_labels, batch_size = 170, validation_data=(test_data, test_labels), epochs=200)
